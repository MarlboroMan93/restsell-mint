const ADDRESS = '0x55ce350d6Cac89ea21CC24e4dfcBD95A1BB892D8';
...
const MAX=5
const namess="Restless";
const discord = 'https://discord.com/invite/restlessnft';
const twitter = 'https://twitter.com/restlessnft';
const startCounter = 250;
const endCounter = 1000;
let price = 0.049
...
var progressBar=(mintNumber / endCounter * 100).toFixed(3);
if(progressBar>=100){
    progressBar=100;
}
